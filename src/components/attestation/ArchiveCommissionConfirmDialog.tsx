...
export function ArchiveCommissionConfirmDialog({ open, onOpenChange, fullName, archiving, onConfirm }: Props) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogTitle>Архівувати запис?</DialogTitle>
        <p className="text-sm text-muted-foreground">
          Запис «{fullName}» буде приховано з довідника активних членів. Продовжити?
        </p>
